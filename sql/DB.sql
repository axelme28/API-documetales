...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `LOG-IN`(IN correo varchar(100))
BEGIN

select usuario.correo_u, usuario.contraseña_u from usuario where correo_u=correo;
...
-- Dump completed on 2021-10-12 21:06:51

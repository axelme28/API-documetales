...
INSERT INTO `usuario` VALUES (1,'axel@axel.com','axelitobellaco');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `LOG-IN` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `LOG-IN`(IN correo varchar(100), IN pass varchar(50))
BEGIN

select usuario.correo_u, usuario.contrasena_u from usuario where correo_u=correo;
...
-- Dump completed on 2021-10-23 16:53:28
